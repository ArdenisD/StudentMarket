                ...
                child: Column(
                  ...
                  children: [
                    ClipRRect(
                      ...
                      child: Image.asset(
                        'assets/images/student-market-high-resolution-logo-transparent.png',
                        width: 300.0,
                        fit: BoxFit.cover,
                      ),
                    ),
                      ...
                      children: [
                        ...
                        Align(
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              logFirebaseEvent(
                                  'LOGIN_PAGE_Text_5lm7gd4k_ON_TAP');
                    ...
                    FFButtonWidget(
                      ...
                      onPressed: () async {
                        ...
                        logFirebaseEvent('signInButton_update_app_state');
                        FFAppState().loginAmount = FFAppState().loginAmount + 1;
                        safeSetState(() {});
                        logFirebaseEvent('signInButton_navigate_to');
                    ...
                    FFButtonWidget(
                      onPressed: () async {
                        logFirebaseEvent('LOGIN_PAGE_signInButton_ON_TAP');
                        logFirebaseEvent('signInButton_bottom_sheet');
                      ...
                      text: getRemoteConfigString('signup_button_text'),
                      options: FFButtonOptions(
                        width: 300.0,
                        height: 40.0,
                        padding:

            ...
            child: Column(
              ...
              children: [
                InkWell(
                  ...
                  onTap: () async {
                    logFirebaseEvent('SIGN_UP_COMP_Text_2fct4169_ON_TAP');
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        image: DecorationImage(
                          fit: BoxFit.cover,
                          image: Image.network(
                            _model.uploadedFileUrl_profileImage,
                          ).image,
                        ),
                            ...
                            child: FlutterFlowIconButton(
                              ...
                              onPressed: () async {
                                ...
                                if (selectedMedia != null &&
                                  ...
                                  safeSetState(() => _model
                                      .isDataUploading_profileImage = true);
                                  ...
                                  try {
                                    ...
                                    _model.isDataUploading_profileImage = false;
                                  }
                                  if (selectedUploadedFiles.length ==
                                      ...
                                      downloadUrls.length ==
                                          selectedMedia.length) {
                                    safeSetState(() {
                                      _model.uploadedLocalFile_profileImage =
                                ...
                                await currentUserReference!
                                  ...
                                  photoUrl: _model.uploadedFileUrl_profileImage,
                                ));
                                logFirebaseEvent(
                                    'IconButton_rebuild_component');
                                safeSetState(() {});
                              },
                            ),
                          ),
                    ...
                    Container(
                      ...
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                          ...
                          suffixIcon: InkWell(
                            onTap: () async {
                              safeSetState(() => _model.enterPassVisibility =
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        Text(
                          'Step 2 of 2 — University & profile',
                          style:
                              FlutterFlowTheme.of(context).bodyMedium.override(
                                    font: GoogleFonts.inter(
                                      fontWeight: FlutterFlowTheme.of(context)
                ...
                Column(
                  ...
                  children: [
                    ...
                    FlutterFlowDropDown<String>(
                      controller: _model.universitiesValueController ??=
                      ...
                      onChanged: (val) =>
                          safeSetState(() => _model.universitiesValue = val),
                      width: 300.0,
                      height: 50.0,
                      searchHintTextStyle:
                          FlutterFlowTheme.of(context).labelMedium.override(
                      ...
                      searchHintText: 'Search university...',
                      icon: Icon(
                        Icons.search,
                ...
                Column(
                  ...
                  children: [
                    ...
                    FlutterFlowDropDown<String>(
                      controller: _model.gradYearsValueController ??=
                          FormFieldController<String>(null),
                      options: ['2026', '2027', '2028', '2029'],
                      onChanged: (val) =>
                          safeSetState(() => _model.gradYearsValue = val),
                      width: 300.0,
                      height: 50.0,
                      searchHintTextStyle:
                          FlutterFlowTheme.of(context).labelMedium.override(
                          ...
                          children: [
                            ...
                            Column(
                              ...
                              children: [
                                ...
                                Text(
                                  'Accept our Terms and Guidelines',
                                  textAlign: TextAlign.start,
                                  style: FlutterFlowTheme.of(context)
                                      .bodyMedium
                                      .override(
                ...
                FFButtonWidget(
                  onPressed: () async {
                    logFirebaseEvent('SIGN_UP_COMP_continueButton_ON_TAP');
                    logFirebaseEvent('continueButton_auth');
                    ...
                    await UserDataRecord.collection.doc(user.uid).update({
                      ...createUserDataRecordData(
                        email: _model.uniEmailTextController.text,
                        photoUrl: _model.uploadedFileUrl_profileImage,
                        agreedTerms: _model.checkboxValue,
                        bio: _model.textFieldTextController.text,
                        gradYear: _model.gradYearsValue,
                        univsersity: _model.universitiesValue,
                    ...
                    logFirebaseEvent('continueButton_navigate_to');

                    context.pushNamedAuth(
                      SearchHomeWidget.routeName,
                      context.mounted,
                      extra: <String, dynamic>{
                        '__transition_info__': TransitionInfo(
                          hasTransition: true,

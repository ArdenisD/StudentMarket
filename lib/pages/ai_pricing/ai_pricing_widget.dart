            ...
            children: [
              Row(
                ...
                children: [
                  FlutterFlowIconButton(
                    ...
                    onPressed: () async {
                      logFirebaseEvent('AI_PRICING_COMP_arrow_back_ICN_ON_TAP');
              ...
              FFButtonWidget(
                onPressed: () async {
                  ...
                  _model.apiResultr0q = await AiPricingCall.call(
                    message: _model.textController.text,
                  );

                  if ((_model.apiResultr0q?.succeeded ?? true)) {
                    logFirebaseEvent('Button_update_component_state');
                    _model.apiResponse = (_model.apiResultr0q?.bodyText ?? '');
                    safeSetState(() {});
                  } else {

...
class SignUp2Widget extends StatefulWidget {
  ...
  static String routeName = 'signUp-2';
  static String routePath = '/signUp-2';
...
class _SignUp2WidgetState extends State<SignUp2Widget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.apiResult0ly = await UnivsersityNamesCall.call();

      if ((_model.apiResult0ly?.succeeded ?? true)) {
        FFAppState().universityNameList =
            ((_model.apiResult0ly?.jsonBody ?? '') as List)
                      ...
                      FFButtonWidget(
                        onPressed: () async {
                          await currentUserReference!
                            ...
                            univsersity: _model.dropDownValue1,
                            gradYear: _model.dropDownValue2,

...
class SignUp1Widget extends StatefulWidget {
  ...
  static String routeName = 'signUp-1';
  static String routePath = '/signUp-1';
                              ...
                              child: FlutterFlowIconButton(
                                ...
                                onPressed: () async {
                                  ...
                                  if (selectedMedia != null &&
                                    ...
                                    safeSetState(() => _model
                                        .isDataUploading_uploadDataZ4f = true);
                                    ...
                                    try {
                                      ...
                                      _model.isDataUploading_uploadDataZ4f =
                                          false;
                                    }
                                    if (selectedUploadedFiles.length ==
                                        ...
                                        downloadUrls.length ==
                                            selectedMedia.length) {
                                      safeSetState(() {
                                        _model.uploadedLocalFile_uploadDataZ4f =
                                            selectedUploadedFiles.first;
                                        _model.uploadedFileUrl_uploadDataZ4f =
                                            downloadUrls.first;
                                      });
                                    } else {
                                      safeSetState(() {});
